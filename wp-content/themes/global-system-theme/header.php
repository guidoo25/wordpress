...
<head>
    ...
    <?php wp_head(); ?>
    <style>
        /* Habilita desplazamiento suave para anclas en la página */
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            ...
            if (target) {
                ...
                var headerOffset = 80; // Offset for fixed header if any
                ...
                // If target doesn't exist and we're not on home, navigate there
                var currentPath = window.location.pathname;
                var homePath = '<?php echo esc_url(home_url('/')); ?>';
                
                if (!currentPath.endsWith('/') && currentPath !== homePath.replace(/https?:\/\/[^\/]+/, '')) {
                    e.preventDefault();
